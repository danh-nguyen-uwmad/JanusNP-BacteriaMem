...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf156.gro -r conf156.gro -p system.top -o npt156.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt156 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt156.gro -r npt156.gro -t npt156.cpt -p system.top -o umbrella156.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella156

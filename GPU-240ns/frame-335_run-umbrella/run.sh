...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf335.gro -r conf335.gro -p system.top -o npt335.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt335 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt335.gro -r npt335.gro -t npt335.cpt -p system.top -o umbrella335.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella335

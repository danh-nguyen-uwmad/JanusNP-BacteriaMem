...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf994.gro -r conf994.gro -p system.top -o npt994.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt994 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt994.gro -r npt994.gro -t npt994.cpt -p system.top -o umbrella994.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella994

...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf547.gro -r conf547.gro -p system.top -o npt547.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt547 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt547.gro -r npt547.gro -t npt547.cpt -p system.top -o umbrella547.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella547

...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf523.gro -r conf523.gro -p system.top -o npt523.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt523 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt523.gro -r npt523.gro -t npt523.cpt -p system.top -o umbrella523.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella523

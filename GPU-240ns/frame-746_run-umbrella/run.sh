...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf746.gro -r conf746.gro -p system.top -o npt746.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt746 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt746.gro -r npt746.gro -t npt746.cpt -p system.top -o umbrella746.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella746

...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf908.gro -r conf908.gro -p system.top -o npt908.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt908 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt908.gro -r npt908.gro -t npt908.cpt -p system.top -o umbrella908.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella908

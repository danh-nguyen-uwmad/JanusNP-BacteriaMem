...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf571.gro -r conf571.gro -p system.top -o npt571.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt571 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt571.gro -r npt571.gro -t npt571.cpt -p system.top -o umbrella571.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella571

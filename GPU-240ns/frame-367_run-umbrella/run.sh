...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf367.gro -r conf367.gro -p system.top -o npt367.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt367 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt367.gro -r npt367.gro -t npt367.cpt -p system.top -o umbrella367.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella367

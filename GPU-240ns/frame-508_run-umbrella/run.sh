...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf508.gro -r conf508.gro -p system.top -o npt508.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt508 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt508.gro -r npt508.gro -t npt508.cpt -p system.top -o umbrella508.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella508

...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf174.gro -r conf174.gro -p system.top -o npt174.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt174 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt174.gro -r npt174.gro -t npt174.cpt -p system.top -o umbrella174.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella174

...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf317.gro -r conf317.gro -p system.top -o npt317.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt317 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt317.gro -r npt317.gro -t npt317.cpt -p system.top -o umbrella317.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella317

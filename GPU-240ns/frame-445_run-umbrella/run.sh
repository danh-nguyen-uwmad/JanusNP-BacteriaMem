...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf445.gro -r conf445.gro -p system.top -o npt445.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt445 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt445.gro -r npt445.gro -t npt445.cpt -p system.top -o umbrella445.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella445

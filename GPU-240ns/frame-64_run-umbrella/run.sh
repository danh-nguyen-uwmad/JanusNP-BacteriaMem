...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf64.gro -r conf64.gro -p system.top -o npt64.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt64 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt64.gro -r npt64.gro -t npt64.cpt -p system.top -o umbrella64.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella64

...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf92.gro -r conf92.gro -p system.top -o npt92.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt92 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt92.gro -r npt92.gro -t npt92.cpt -p system.top -o umbrella92.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella92

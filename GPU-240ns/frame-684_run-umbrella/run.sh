...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf684.gro -r conf684.gro -p system.top -o npt684.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt684 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt684.gro -r npt684.gro -t npt684.cpt -p system.top -o umbrella684.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella684

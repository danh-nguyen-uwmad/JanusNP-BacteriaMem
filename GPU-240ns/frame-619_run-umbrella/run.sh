...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf619.gro -r conf619.gro -p system.top -o npt619.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt619 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt619.gro -r npt619.gro -t npt619.cpt -p system.top -o umbrella619.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella619

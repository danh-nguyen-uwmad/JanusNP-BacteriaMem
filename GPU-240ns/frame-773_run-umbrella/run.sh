...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf773.gro -r conf773.gro -p system.top -o npt773.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt773 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt773.gro -r npt773.gro -t npt773.cpt -p system.top -o umbrella773.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella773

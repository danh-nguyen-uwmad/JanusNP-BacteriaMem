...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf213.gro -r conf213.gro -p system.top -o npt213.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt213 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt213.gro -r npt213.gro -t npt213.cpt -p system.top -o umbrella213.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella213

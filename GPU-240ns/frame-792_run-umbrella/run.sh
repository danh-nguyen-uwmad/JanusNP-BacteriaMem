...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf792.gro -r conf792.gro -p system.top -o npt792.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt792 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt792.gro -r npt792.gro -t npt792.cpt -p system.top -o umbrella792.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella792

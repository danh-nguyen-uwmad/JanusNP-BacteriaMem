...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf638.gro -r conf638.gro -p system.top -o npt638.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt638 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt638.gro -r npt638.gro -t npt638.cpt -p system.top -o umbrella638.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella638

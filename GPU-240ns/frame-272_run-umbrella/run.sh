...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf272.gro -r conf272.gro -p system.top -o npt272.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt272 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt272.gro -r npt272.gro -t npt272.cpt -p system.top -o umbrella272.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella272

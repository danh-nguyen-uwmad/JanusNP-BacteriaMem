...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf842.gro -r conf842.gro -p system.top -o npt842.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt842 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt842.gro -r npt842.gro -t npt842.cpt -p system.top -o umbrella842.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella842

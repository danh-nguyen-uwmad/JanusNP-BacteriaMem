...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf705.gro -r conf705.gro -p system.top -o npt705.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt705 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt705.gro -r npt705.gro -t npt705.cpt -p system.top -o umbrella705.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella705

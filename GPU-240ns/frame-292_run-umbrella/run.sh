...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf292.gro -r conf292.gro -p system.top -o npt292.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt292 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt292.gro -r npt292.gro -t npt292.cpt -p system.top -o umbrella292.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella292

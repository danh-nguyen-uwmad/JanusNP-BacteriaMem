...
# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt134.gro -r npt134.gro -t npt134.cpt -p system.top -o umbrella134.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella134

...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf882.gro -r conf882.gro -p system.top -o npt882.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt882 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt882.gro -r npt882.gro -t npt882.cpt -p system.top -o umbrella882.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella882

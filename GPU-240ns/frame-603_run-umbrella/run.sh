...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf603.gro -r conf603.gro -p system.top -o npt603.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt603 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt603.gro -r npt603.gro -t npt603.cpt -p system.top -o umbrella603.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella603

...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf421.gro -r conf421.gro -p system.top -o npt421.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt421 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt421.gro -r npt421.gro -t npt421.cpt -p system.top -o umbrella421.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella421

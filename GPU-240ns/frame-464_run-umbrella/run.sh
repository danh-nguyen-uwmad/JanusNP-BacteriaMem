...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf464.gro -r conf464.gro -p system.top -o npt464.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt464 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt464.gro -r npt464.gro -t npt464.cpt -p system.top -o umbrella464.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella464

...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf352.gro -r conf352.gro -p system.top -o npt352.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt352 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt352.gro -r npt352.gro -t npt352.cpt -p system.top -o umbrella352.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella352

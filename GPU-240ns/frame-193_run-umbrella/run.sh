...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf193.gro -r conf193.gro -p system.top -o npt193.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt193 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt193.gro -r npt193.gro -t npt193.cpt -p system.top -o umbrella193.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella193

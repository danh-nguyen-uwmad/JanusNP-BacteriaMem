...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf928.gro -r conf928.gro -p system.top -o npt928.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt928 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt928.gro -r npt928.gro -t npt928.cpt -p system.top -o umbrella928.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella928

...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf402.gro -r conf402.gro -p system.top -o npt402.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt402 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt402.gro -r npt402.gro -t npt402.cpt -p system.top -o umbrella402.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella402

...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf382.gro -r conf382.gro -p system.top -o npt382.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt382 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt382.gro -r npt382.gro -t npt382.cpt -p system.top -o umbrella382.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella382

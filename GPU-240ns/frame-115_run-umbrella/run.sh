...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf115.gro -r conf115.gro -p system.top -o npt115.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt115 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt115.gro -r npt115.gro -t npt115.cpt -p system.top -o umbrella115.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella115

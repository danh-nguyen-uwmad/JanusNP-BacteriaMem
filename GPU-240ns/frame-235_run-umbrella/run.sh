...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf235.gro -r conf235.gro -p system.top -o npt235.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt235 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt235.gro -r npt235.gro -t npt235.cpt -p system.top -o umbrella235.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella235

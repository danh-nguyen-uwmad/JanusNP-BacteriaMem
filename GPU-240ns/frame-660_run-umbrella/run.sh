...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf660.gro -r conf660.gro -p system.top -o npt660.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt660 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt660.gro -r npt660.gro -t npt660.cpt -p system.top -o umbrella660.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella660

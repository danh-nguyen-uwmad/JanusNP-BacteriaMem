...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf485.gro -r conf485.gro -p system.top -o npt485.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt485 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt485.gro -r npt485.gro -t npt485.cpt -p system.top -o umbrella485.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella485

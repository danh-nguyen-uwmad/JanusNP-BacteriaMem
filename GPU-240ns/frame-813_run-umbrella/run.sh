...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf813.gro -r conf813.gro -p system.top -o npt813.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt813 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt813.gro -r npt813.gro -t npt813.cpt -p system.top -o umbrella813.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella813

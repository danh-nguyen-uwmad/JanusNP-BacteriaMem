...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf255.gro -r conf255.gro -p system.top -o npt255.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt255 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt255.gro -r npt255.gro -t npt255.cpt -p system.top -o umbrella255.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella255

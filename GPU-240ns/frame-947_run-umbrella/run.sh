...
# Short equilibration
gmx grompp -f npt_umbrella.mdp -c conf947.gro -r conf947.gro -p system.top -o npt947.tpr  -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm npt947 

# Umbrella run
gmx grompp -f md_umbrella.mdp -c npt947.gro -r npt947.gro -t npt947.cpt -p system.top -o umbrella947.tpr -n index.ndx -maxwarn 11
gmx mdrun -v -ntomp 52 -deffnm umbrella947
